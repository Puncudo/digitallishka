...
@media (min-width: 768px) {
  ...
  .ind-chips  { display: none; }
  .ind-info   { display: none; }
  ...
  .badge-warn { color: #FF1D47; font-size: 15px; }
  .badge-status {
  ...
  .badge-status--active  { background: #fef9c3; color: #92400e; }
  .badge-status--closed  { background: #dcfce7; color: #15803d; }
  .badge-status--warning { background: #fee2e2; color: #b91c1c; }
  .badge-status--neutral { background: var(--bg); color: var(--text-muted); }
}
</style>
